...
if __name__ == "__main__":
    ...
    for epoch in range(1, opt.n_epoch + 1):
        ...
        if epoch % opt.n_snapshot == 0 or epoch == opt.n_epoch:
            ...
            np.random.seed(101)
            valid_repeat_times = {"data": 10, "BSD300": 3, "Set14": 20}
...
# python train.py --data_dir=./data --val_dirs=./validation --noisetype=gauss25 --save_model_path=./results --log_name=unet_gauss25_b4e100r02 --increase_ratio=2